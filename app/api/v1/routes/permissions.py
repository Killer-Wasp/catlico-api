...
PERMISSION_CATALOG: list[PermissionInfo] = [
    ...
    PermissionInfo(key="read:intel", domain="Intel", kind="read",
                   label="View intel",
                   description="Read custom fields and knowledge base."),
    PermissionInfo(key="write:intel", domain="Intel", kind="write",
                   label="Edit intel",
                   description="Manage custom fields and knowledge base."),
    PermissionInfo(key="delete:intel", domain="Intel", kind="delete",
                   label="Delete intel",
                   description="Delete custom fields and knowledge base pages."),
